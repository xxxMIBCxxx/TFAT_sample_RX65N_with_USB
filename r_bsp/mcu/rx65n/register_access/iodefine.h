...
struct st_s12ad1 {
	...
	union {
		...
		struct {
			unsigned short :11;
			unsigned short CMPCHA1:5;
		} BIT;
	} ADCMPANSR1;
	union {
		unsigned short WORD;
		struct {
			unsigned short CMPLCHA0:16;
		} BIT;
	} ADCMPLR0;
	union {
		unsigned short WORD;
...
struct st_sdsi {
	...
	char           wk3[1404];
	unsigned long  FN1DATAR1[64];
	unsigned long  FN1DATAR2[64];
	unsigned long  FN1DATAR3[64];
	union {
		unsigned char BYTE;
		struct {
