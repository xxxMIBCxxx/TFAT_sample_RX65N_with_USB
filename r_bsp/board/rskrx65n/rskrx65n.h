...
*         : 17.09.2015 0.40      First Release
*         : 01.12.2015 0.40(WS2) Change the File Name from rskrx651.h to rskrx65n.h.
*                                Change the H/W Platform from RSKRX651 to RSKRX65N.
*                                Change the macro of Switches and LEDs.
***********************************************************************************************************************/
...
#define LED0_PDR            PORTA.PDR.BIT.B1
