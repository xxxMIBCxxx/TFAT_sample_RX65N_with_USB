...
#if (TFAT_DRIVE_ALLOC_NUM_0 == TFAT_CTRL_SDHI)
#define SDHI_NUM_0    (1)
#define DRV0_DEV_CH   (0)
#else
#define SDHI_NUM_0    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_0 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_1 == TFAT_CTRL_SDHI)
#define SDHI_NUM_1    (1<<1)
#define DRV1_DEV_CH   (0 + SDHI_NUM_0)
#else
#define SDHI_NUM_1    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_1 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_2 == TFAT_CTRL_SDHI)
#define SDHI_NUM_2    (1<<2)
#define DRV2_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1))
#else
#define SDHI_NUM_2    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_2 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_3 == TFAT_CTRL_SDHI)
#define SDHI_NUM_3    (1<<3)
#define DRV3_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2))
#else
#define SDHI_NUM_3    (0)
#endif //  (TFAT_DRIVE_ALLOC_NUM_3 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_4 == TFAT_CTRL_SDHI)
#define SDHI_NUM_4    (1<<4)
#define DRV4_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3))
#else
#define SDHI_NUM_4    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_4 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_5 == TFAT_CTRL_SDHI)
#define SDHI_NUM_5    (1<<5)
#define DRV5_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3) + (SDHI_NUM_4>>4))
#else
#define SDHI_NUM_5    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_5 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_6 == TFAT_CTRL_SDHI)
#define SDHI_NUM_6    (1<<6)
#define DRV6_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3) + (SDHI_NUM_4>>4) + (SDHI_NUM_5>>5))
#else
#define SDHI_NUM_6    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_6 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_7 == TFAT_CTRL_SDHI)
#define SDHI_NUM_7    (1<<7)
#define DRV7_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3) + (SDHI_NUM_4>>4) + (SDHI_NUM_5>>5) + (SDHI_NUM_6>>6))
#else
#define SDHI_NUM_7    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_7 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_8 == TFAT_CTRL_SDHI)
#define SDHI_NUM_8    (1<<8)
#define DRV8_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3) + (SDHI_NUM_4>>4) + (SDHI_NUM_5>>5) + (SDHI_NUM_6>>6) + (SDHI_NUM_7>>7))
#else
#define SDHI_NUM_8    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_8 == TFAT_CTRL_SDHI)
#if (TFAT_DRIVE_ALLOC_NUM_9 == TFAT_CTRL_SDHI)
#define SDHI_NUM_9    (1<<9)
#define DRV9_DEV_CH   (0 + SDHI_NUM_0 + (SDHI_NUM_1>>1) + (SDHI_NUM_2>>2) + (SDHI_NUM_3>>3) + (SDHI_NUM_4>>4) + (SDHI_NUM_5>>5) + (SDHI_NUM_6>>6) + (SDHI_NUM_7>>7) + (SDHI_NUM_8>>8))
#else
#define SDHI_NUM_9    (0)
#endif // (TFAT_DRIVE_ALLOC_NUM_9 == TFAT_CTRL_SDHI)

static uint32_t TFAT_DRIVE_SDHI_ALLOC = (SDHI_NUM_9 | SDHI_NUM_8 | SDHI_NUM_7 | SDHI_NUM_6 | SDHI_NUM_5 | SDHI_NUM_4 | SDHI_NUM_3 | SDHI_NUM_2 | SDHI_NUM_1 | SDHI_NUM_0);

#if TFAT_SDHI_DRIVE_NUM != ( (SDHI_NUM_9>>9)+(SDHI_NUM_8>>8)+(SDHI_NUM_7>>7)+(SDHI_NUM_6>>6)+(SDHI_NUM_5>>5)+(SDHI_NUM_4>>4)+(SDHI_NUM_3>>3)+(SDHI_NUM_2>>2)+(SDHI_NUM_1>>1)+SDHI_NUM_0 )
#error "Error! Invalid setting for TFAT_SDHI_DRIVE_NUM or TFAT_DRIVE_ALLOC_NUM_x in r_tfat_driver_rx_config.h"
#endif
...
/******************************************************************************
* Function Name : chk_use_sdhi
* Description   : allocation check
* Arguments     : uint8_t drive : Physical drive number for TFAT module
* Return value  : true : 0x01
******************************************************************************/
#if (TFAT_SDHI_DRIVE_NUM > 0)
static uint8_t chk_use_sdhi(uint8_t drive)
{
    return ( ( (TFAT_DRIVE_SDHI_ALLOC & (0x01 << drive) ) != 0) ?  0x01 : 0x00);
}
#endif // USE_SDHI
...
#if (TFAT_SDHI_DRIVE_NUM > 0)
    if ( chk_use_sdhi(drive) )
    {
        ret = R_tfat_sdhi_disk_initialize( drive_alloc_tbl[drive][1] ); /* function for SDHI */
    }
#endif
...
)
{
    ...
    if ( chk_use_sdhi(drive) )
    {
        ret = R_tfat_sdhi_disk_read( drive_alloc_tbl[drive][1], buffer, sector_number, sector_count ); /* function for SDHI */
    }
#endif
...
)
{
    ...
    if ( chk_use_sdhi(drive) )
    {
        ret = R_tfat_sdhi_disk_write( drive_alloc_tbl[drive][1], buffer, sector_number, sector_count ); /* function for SDHI */
    }
#endif
...
)
{
    ...
    if ( chk_use_sdhi(drive) )
    {
        ret = R_tfat_sdhi_disk_ioctl ( drive_alloc_tbl[drive][1], command, buffer ); /* function for SDHI */
    }
#endif
...
)
{
    ...
    if ( chk_use_sdhi(drive) )
    {
        ret = R_tfat_sdhi_disk_status ( drive_alloc_tbl[drive][1] ); /* function for SDHI */
    }
#endif
...
#endif
#if (TFAT_SDHI_DRIVE_NUM > 0)
    if ( TFAT_CTRL_SDHI == dev_type )
    {
        TFAT_DRIVE_SDHI_ALLOC |= (0x01 << tfat_drv);
    }
    else
    {
        TFAT_DRIVE_SDHI_ALLOC &= ~(0x01 << tfat_drv);
