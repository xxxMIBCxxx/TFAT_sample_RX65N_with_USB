...
#ifndef __R_USB_DEFINE_H__
    #define __R_USB_DEFINE_H__
...
/* Condition compilation by the difference of the endian */
    ...
    #define CLSDATASIZE     (32u)               /* Transfer data size for Standard Request */
            ...
            #define USB_MSTP    (MSTP_USB0)
            #define USE_USBIP   (USB_IP0)
        #else
            #define USB_MSTP    (MSTP_USBA)
 ...
 *************************************************************************/
    ...
    #define R_USB_SND_MSG(ID, MESS)         (usb_cstd_SndMsg((uint8_t)(ID), (usb_msg_t*)(MESS)))
    #define USB_ISND_MSG(ID, MESS)          (usb_cstd_isnd_msg((uint8_t)(ID), (usb_msg_t*)(MESS)))
    #define R_USB_ISND_MSG(ID, MESS)        (usb_cstd_iSndMsg((uint8_t)(ID), (usb_msg_t*)(MESS)))
    #define USB_WAI_MSG(ID, MESS, TM)       (usb_cstd_wai_msg((uint8_t)(ID), (usb_msg_t*)(MESS), (usb_tm_t)(TM)))
    #define R_USB_WAI_MSG(ID, MESS, TM)     (usb_cstd_WaiMsg((uint8_t)(ID), (usb_msg_t*)(MESS), (usb_tm_t)(TM)))
    #define USB_RCV_MSG(ID, MESS)           (usb_cstd_rec_msg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(0u)))
    #define R_USB_RCV_MSG(ID, MESS)         (usb_cstd_RecMsg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(0u)))
    #define R_USB_TRCV_MSG(ID, MESS, TM)    (usb_cstd_RecMsg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(TM)))
    #define USB_TRCV_MSG(ID, MESS, TM)      (usb_cstd_rec_msg((uint8_t)(ID), (usb_msg_t**)(MESS), (usb_tm_t)(TM)))

    #define R_USB_PGET_BLK(ID, BLK)         (usb_cstd_PgetBlk((uint8_t)(ID), (usb_utr_t**)(BLK)))
    #define USB_PGET_BLK(ID, BLK)           (usb_cstd_pget_blk((uint8_t)(ID),(usb_utr_t**)(BLK)))
    #define R_USB_REL_BLK(ID, BLK)          (usb_cstd_RelBlk((uint8_t)(ID), (usb_utr_t*)(BLK)))
